...
public class JvmBcClassRemapper {
	public static JvmBcClass process(JvmBcClass classToRemap, BcClassRemapNameProvider renameProvider) {
		JvmBcClassRemapper remapper = new JvmBcClassRemapper(classToRemap, renameProvider);
		return remapper.remap();
	}

	private JvmBcClassRemapper(JvmBcClass bcClass, BcClassRemapNameProvider renameProvider) {
	...
	private class AsmClassRemapper extends ClassRemapper {
		private AsmClassRemapper(ClassVisitor cv, BcClassRemapNameProvider renameProvider) {
