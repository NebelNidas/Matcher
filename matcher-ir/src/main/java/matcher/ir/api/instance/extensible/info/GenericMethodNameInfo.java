...
import matcher.ir.api.instance.info.MethodNameInfo;

public interface GenericMethodNameInfo<
		...
		MV extends GenericMethodVarInstance<C, F, M, MA, MV>> extends MethodNameInfo {
	@Override
	@NotNull
	M getOwner();
}
