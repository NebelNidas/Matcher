...
public abstract class MemberInstance<T extends MemberInstance<T>> implements Instance<T> {
	...
	public static final Comparator<MemberInstance<?>> nameComparator = Comparator.<MemberInstance<?>, String>comparing(MemberInstance::getName).thenComparing(m -> m.getDescriptor());
